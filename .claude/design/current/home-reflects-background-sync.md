...
tags:
  [
    HomeClient,
    useVisiblePoll,
    src/components/useVisiblePoll.ts,
    AccountView,
    refresh,
    visibilitychange,
    scheduled sync,
