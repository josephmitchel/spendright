...
After you know what audit it is, navigate to that audit's folder in `.claude/snapshot/audits`, familiarize yourself with the findings of that audit, and then come up with a plan to address every concern in the audit from the concern level they requested. Ask the user any questions if you are unsure about what direction you should go with a change. Never assume, no stupid questions.